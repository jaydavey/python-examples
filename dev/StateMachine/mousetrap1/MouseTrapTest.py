...
import string, sys
sys.path += ['/home/jay/python/python-examples/dev/StateMachine', '/home/jay/python/python-examples/dev/StateMachine/mouse']
...
moves = open("../mouse/MouseMoves.txt").readlines()
#pdb.set_trace()
