'''Dictionary is a collection of related data PAIRS. For instance, if we 
...
myDict["New item"] = "I’m new" print(myDict) 
...
del myDict["One"] print(myDict) #You’ll get {2.5: 'Two and a Half', 3: '+', 7.9: 2, 'New item': 'I’m new'}
